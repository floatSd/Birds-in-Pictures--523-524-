...
# County(27), Observation Date(106), Genus(14), Species(15), Common Name(114), Observation Count Alteast(104), Latitude-Longitude(33,34)
# The db name can be set according to the source/target of the data

BEGIN {FS="\t";OFS=",";dbname="complete_ny_ebird_data";}
$3=="Observation" && $25=="United States" && $26=="New York" && $37>=2009 && $15!="" && $114!="" && $106!=""{
	county_name=$27;
	common_name=$114;
	obs_count=$104;
	rep_count=$103;
...
#	print "insert into "dbname" values("county_name",convert(datetime,'"$106"'),'"$14"','"$15"','"common_name"',"obs_count","$33","$34");";
	print $27","$106","$14","$15","$114","$104","$33","$34
}